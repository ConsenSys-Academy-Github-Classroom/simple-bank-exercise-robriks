...
contract SimpleBank {
    ...
    function enroll() public returns (bool) {
      // 1. enroll the sender of this transaction
    ...
    function deposit() public payable returns (uint) {    
      ...
      // Emit the appropriate event associated with this function
      emit LogDepositMade(msg.sender, msg.value);
      // return the balance of sender of this transaction
      return balances[msg.sender];
    }
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
      ...
      // Transfer Eth to sender & decrement withdrawal amount from sender's balance 
      // *done in opposite order to prevent re-entrance exploit*
      balances[msg.sender] -= withdrawAmount;
      msg.sender.transfer(withdrawAmount);
      // Emit the appropriate event for this message
